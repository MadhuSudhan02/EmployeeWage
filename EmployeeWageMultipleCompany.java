...
public class EmployeeWageMultipleCompany {
    ...
    EmployeeWageMultipleCompany(String companyName, int EMP_RATE_PER_HOUR, int MAX_HRS_IN_MONTHS,
    ...
    public static void main(String[] args) {
        EmployeeWageMultipleCompany dell = new EmployeeWageMultipleCompany("Dell",500,160,21,6,3);
        dell.companyInfo();
        dell.wageComputation();
        EmployeeWageMultipleCompany lenovo = new EmployeeWageMultipleCompany("Lenovo",450,150,22,8,4);
        lenovo.companyInfo();
